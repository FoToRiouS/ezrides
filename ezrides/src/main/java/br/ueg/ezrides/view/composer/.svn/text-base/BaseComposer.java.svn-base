...
/**
 * Controlador de telas básicos, que deve ser usuado pelos composers do sistema.
 * @author fotorious
 *
 * @param <E> Entidade que herde de {@link ICommonEntity}.
 * @param <G> Controller que herde de {@link GenericControl}.
 */
@SuppressWarnings("serial")
public abstract class BaseComposer<E extends ICommonEntity, G extends GenericControl<E>> extends CRUDComposer<E, G> {
